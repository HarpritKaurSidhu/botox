...
public class ProviderProfileUpdateActivity extends BaseActivity {
       ...
       getProviderProfile(((BotoxApplication)getApplication()).getProvider().getAccessToken());
        ...
        buttonSchedule.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(ProviderProfileUpdateActivity.this,ScheduleActivity.class);
        ...
        buttonMyAppointment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ProviderProfileUpdateActivity.this,MyAppointmentActivity.class);
                startActivity(intent);
            }
        });
        ...
        buttonMyPayment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(ProviderProfileUpdateActivity.this,ProviderPayment.class);
                startActivity(intent);
            }
        });
        ...
        call.enqueue(new Callback<Provider>() {
            ...
            public void onResponse(Call<Provider> call, Response<Provider> response) {
                ...
                if (statusCode == 200) {
                    ...
                    Glide.with(ProviderProfileUpdateActivity.this).load(((BotoxApplication)getApplication()).getProvider().getImageUrl()).placeholder(R.drawable.ic_dummy_user).dontAnimate().into(userImage);
